...
class Flecha3D : public MallaRevol
{
   public:
      Flecha3D(int n,int m, int nrev);  
};

class Prisma : public MallaRevol
{
   public:
      Prisma(int n, int nrev);  
};

class Fuente : public MallaRevol
{
   public:
      Fuente(int nrev);  
};

class CilindroConTapa : public MallaRevol
{
   public:
   // Constructor: crea el perfil original y llama a inicializar
   // la base tiene centro en el origen, el radio y la altura son 1
