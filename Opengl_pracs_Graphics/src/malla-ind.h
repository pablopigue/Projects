...
class PiramideEstrellaZ2 : public MallaInd
{
   public:
      PiramideEstrellaZ2(int n);
};

class RejillaY : public MallaInd
{
   public:
      RejillaY(int m,int n);
};
...
class PiramideBaseRara : public MallaInd
{
   public:
      PiramideBaseRara();
};

class Practicando : public MallaInd
{
   public:
      Practicando();
};

class Practicando2 : public MallaInd
{
   public:
      Practicando2(int n);
};
...
class MallaDiscoP42 : public MallaInd
{
   public:
      MallaDiscoP42();
};

class PiramidePract : public MallaInd
{
   public:
      PiramidePract();
};
